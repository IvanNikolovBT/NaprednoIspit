...
class MapOps
{
   public static <K extends Comparable<K>,V> Map<K,V> merge(Map<K,V> left,Map<K,V>right,MergingStrategy<V>strategy)
   {
...
public class GenericMapTest {
    public static void main(String[] args) {
        ...
        if (testCase == 1) { //Mergeable integers
            ...
            MergeStrategy<Integer> mergeStrategy =(k,v)->k+v;
            ...
            MergeStrategy<String> mergeStrategy = (k,v)->k+v;
